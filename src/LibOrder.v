...
Arguments preorder_trans [A R p] _ [x z].
...
Arguments total_preorder_trans [A R] _ _ [x z].
...
Arguments order_trans [A R o] _ [x z].
...
Arguments total_order_trans [A R o] _ [x z].
...
Arguments strict_order_trans [A R s] _ [x z].
...
Arguments strict_total_order_trans [A R s] _ [x z].
...
Arguments le_trans {A H Le_trans} _ [x z].
Arguments ge_trans {A H Ge_trans} _ [x z].
Arguments lt_trans {A H Lt_trans} _ [x z].
Arguments gt_trans {A H Gt_trans} _ [x z].
...
Arguments nle_to_sle {A H NLe_to_SLe} [x y].
